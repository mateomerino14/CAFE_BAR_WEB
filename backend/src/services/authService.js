...
const DIRECTORIO_PERMISSIONS = [
  'Home', 'Familia', 'Caja', 'Administracion',
  'Productos', 'Secciones', 'Stock', 'Promociones', 'Empleados', 'Reportes',
  'REGISTRAR_PEDIDO', 'CONFIGURACION', 'VER_REPORTES'
];
...
export const loadEmployeePermissions = async (idCargo) => {
  ...
  if (!permissions.includes('Home')) permissions.push('Home');
